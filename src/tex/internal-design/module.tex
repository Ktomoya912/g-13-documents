...
\begin{itemize}
  \item 節\ref{sec:overlay}, \texttt{overlay}は、アプリケーション上で一番上のレイヤーに表示されるウィジェットをまとめたモジュールについて記述している。
  \item 節\ref{sec:provider}, \texttt{provider}は、アプリケーション全体で使用する共通の変数をまとめたモジュールについて記述している。
  \item 節\ref{sec:page}, \texttt{page}は、アプリケーションの画面をまとめたモジュールについて記述している。
  \item 節\ref{sec:component}, \texttt{component}は、pageで用いられるパーツをまとめたモジュールについて記述している。
\end{itemize}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/abstract/overlay.pdf}
  \caption{overlayのモジュール構成図}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/abstract/provider.pdf}
  \caption{providerのモジュール構成図}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/abstract/page.pdf}
  \caption{pageのモジュール構成図}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/abstract/component.pdf}
  \caption{componentのモジュール構成図}
\end{figure}
...
\clearpage
\subsection{page}\label{sec:page}
\begin{table}[H]
  \centering
  \begin{tabular}{|c|l|l|} \hline

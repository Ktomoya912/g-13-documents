...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    モジュール名 & \multicolumn{2}{l|}{rule.dart}  \\ \hline
    モジュール概要 & \multicolumn{2}{p{12cm}|}{利用規約のオーバーレイをテストするためのモジュール}           \\ \hline
    責任者 & \multicolumn{2}{l|}{金川幸太}           \\ \hline
    \multirow{7}{*}{構成要素}       & クラス名 & Rule      \\ \cline{2-3}
      & クラス種類 & extends StatelessWidget \\ \cline{2-3}
      & 処理概要 & \multicolumn{1}{p{12cm}|}{利用規約のオーバーレイを表示する。} \\ \cline{2-3}
      & 入力 & なし \\ \cline{2-3}
      & 出力 & Widget \\ \cline{2-3}
      & \multicolumn{2}{l|}{他クラス・関数との関係}  \\ \cline{2-3}
      & \multicolumn{2}{p{14cm}|}{ボタンを押すことで、rule\_screen.dartのRuleScreen().show(context, text)を呼び出す}  \\ \hline
  \end{tabular}
\end{table}

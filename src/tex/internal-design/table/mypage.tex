...
\begin{figure}[H]
  \centering
  \includegraphics[width=9cm]{./images/internal-design/state_change_diagram/mypage/post_member_list.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4.5cm]{./images/internal-design/state_change_diagram/mypage/impressions.pdf}

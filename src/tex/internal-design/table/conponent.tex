\subsection{component}\label{sec:component}

\begin{table}[H]
  \centering
  \begin{tabular}{|c|l|l|} \hline
    モジュール名                & \multicolumn{2}{l|}{post\_list.dart}                                                                                        \\ \hline
    モジュール概要               & \multicolumn{2}{p{12cm}|}{イベント、求人投稿の一覧を表示するモジュール}                                                                            \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/component/post_list.pdf}
  \caption{post\_list.dartの状態遷移図}
\end{figure}
\clearpage
\begin{table}[H]
  \centering
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=6cm]{./images/internal-design/state_change_diagram/component/text_enter_box.pdf}
%   \caption{text\_enter\_box.dartの状態遷移図}
% \end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/component/password_input.pdf}
  \caption{password\_input.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  \centering
  \begin{tabular}{|c|l|l|} \hline
    モジュール名                & \multicolumn{2}{l|}{general\_form.dart}                                                                                                        \\ \hline
    モジュール概要               & \multicolumn{2}{p{12cm}|}{一般ユーザが入力するフォームを出力するコンポーネント}                                                                                          \\ \hline
    責任者                   & \multicolumn{2}{l|}{山本昇永}                                                                                                                      \\ \hline
    \multirow{7}{*}{構成要素} & クラス名                                                                              & generalForm                                                \\ \cline{2-3}
                          & クラス種類                                                                             & extends StatelessWidget                                    \\ \cline{2-3}
                          & 処理概要                                                                              & \multicolumn{1}{p{12cm}|}{一般ユーザ用の入力フォームのWidgetを動的に変更するクラス} \\ \cline{2-3}
                          & 入力                                                                                & bool canEdit                                               \\ \cline{2-3}
                          & 出力                                                                                & Widget                                                     \\ \cline{2-3}
                          & \multicolumn{2}{l|}{他クラス・関数との関係}                                                                                                               \\ \cline{2-3}
                          & \multicolumn{2}{p{14cm}|}{なし}                                                                                                                  \\ \hline
    \multirow{7}{*}{構成要素} & クラス名                                                                              & GeneralFormState                                           \\ \cline{2-3}
                          & クラス種類                                                                             & extends State                                              \\ \cline{2-3}
                          & 処理概要                                                                              & \multicolumn{1}{p{12cm}|}{一般ユーザ用の入力フォームの状態を返すクラス}          \\ \cline{2-3}
                          & 入力                                                                                & なし                                                         \\ \cline{2-3}
                          & 出力                                                                                & State                                                      \\ \cline{2-3}
                          & \multicolumn{2}{l|}{他クラス・関数との関係}                                                                                                               \\ \cline{2-3}
                          & \multicolumn{2}{p{14cm}|}{text\_enter\_box.dartのTextEnterBoxクラスを呼び出すことで入力フォームを表示}                                                              \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{./images/internal-design/state_change_diagram/component/finish_screen.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics{./images/internal-design/state_change_diagram/component/comment_box.pdf}
  \caption{coment\_box.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要               & \multicolumn{2}{p{12cm}|}{任意のテキストが書かれたボタンを生成するモジュール}                                                                                                      \\ \hline
    責任者                   & \multicolumn{2}{l|}{金川幸太}                                                                                                                                \\ \hline
...
% \begin{figure}[H]
%   \centering
%   \includegraphics{./images/internal-design/state_change_diagram/component/botton_set.pdf}
%   \caption{botton\_set.dartの状態遷移図}
% \end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要               & \multicolumn{2}{p{12cm}|}{二つの条件を切り替えるtoggleButtonを作成するモジュール}                                                                          \\ \hline
    責任者                   & \multicolumn{2}{l|}{新谷光城}                                                                                                            \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=9cm]{./images/internal-design/state_change_diagram/component/toggle_button.pdf}
  \caption{toggle\_button.dartの状態遷移図}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale = 1]{./images/internal-design/state_change_diagram/component/title_appbar.pdf}
  \caption{title\_appbar.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  \centering
  \begin{tabular}{|c|l|l|} \hline
    モジュール名                & \multicolumn{2}{l|}{over\_screen\_controller.dart}                                                            \\ \hline
    モジュール概要               & \multicolumn{2}{p{12cm}|}{オーバーレイの表示、非表示の操作を行うコンポーネント}                                                         \\ \hline
    責任者                   & \multicolumn{2}{l|}{金川幸太}                                                                                     \\ \hline
    \multirow{7}{*}{構成要素} & クラス名                                                                & OverScreenController                    \\ \cline{2-3}

...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/login/login_page.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=10cm]{./images/internal-design/state_change_diagram/login/ask_page.pdf}

\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{ログイン画面を生成するレイヤー} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{法人用の新規会員登録画面を生成するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{山本昇永} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{一般用の新規会員登録画面を生成するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{山本昇永} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{パスワード再設定画面を生成するレイヤー} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{問い合わせ画面を生成するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{金川幸太} \\ \hline

...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/job/job.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/job/job_post_write.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=18.5cm]{./images/internal-design/state_change_diagram/job/job_post_detail.pdf}

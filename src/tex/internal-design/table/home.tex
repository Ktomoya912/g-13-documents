\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{ホーム画面を作成するレイヤー} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{通知画面を作成するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{通知の詳細画面を表示するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline
    \multirow{7}{*}{構成要素} & クラス名 & NoticeDetail \\ \cline{2-3}
                            & クラス種類 & extends StatelessWidget \\ \cline{2-3}
                            & 処理概要 & \multicolumn{1}{p{12cm}|}{任意の通知詳細画面を生成するクラス} \\ \cline{2-3}
                            & 入力 & List$<$List$<$Map$<$String, dynamic$>$$>$$>$ titles, int is\_event, int index, String detail \\ \cline{2-3}
                            & 出力 & Widget \\ \cline{2-3}
                            & \multicolumn{2}{l|}{他クラス・関数との関係} \\ \cline{2-3}
                            & \multicolumn{2}{p{14cm}|}{
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{応募を行った求人広告一覧を表示するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline

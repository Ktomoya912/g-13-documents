...
\begin{figure}[H]
  \centering
  \includegraphics{./images/internal-design/state_change_diagram/event/else_list.pdf}
  \caption{else\_list.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{イベント広告詳細画面を表示するモジュール} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[scale = 0.7]{./images/internal-design/state_change_diagram/event/event_post_detail.pdf}
  \caption{event\_post\_detail.dartの状態遷移図}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale= 0.8]{./images/internal-design/state_change_diagram/event/event.pdf}
  \caption{event.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{法人利用者が投稿を行ったイベント、求人広告の一覧を表示するモジュール} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{./images/internal-design/state_change_diagram/event/posted_list.pdf}
  \caption{posted\_list.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{イベント広告内容記述画面を表示するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline
    \multirow{7}{*}{構成要素} & クラス名 & EventPostWrite \\ \cline{2-3}
                            ...
                            & 出力 & Widget \\ \cline{2-3}
                            & \multicolumn{2}{l|}{他クラス・関数との関係} \\ \cline{2-3}
                            & \multicolumn{2}{p{14cm}|}{change\_generalcorporation.dartのChangeGeneralCorporationプロバイダを組み込む
...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/event/event_post_write.pdf}
  \caption{event\_post\_write.dartの状態遷移図}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|l|l|} \hline
    ...
    モジュール概要 & \multicolumn{2}{p{12cm}|}{投稿したいと考えている内容が投稿時どのように見えるのかの確認を行う画面を表示するレイヤー} \\ \hline
    責任者 & \multicolumn{2}{l|}{新谷光城} \\ \hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{./images/internal-design/state_change_diagram/event/post_write_comp.pdf}
  \caption{post\_write\_comp.dartの状態遷移図}
\end{figure}